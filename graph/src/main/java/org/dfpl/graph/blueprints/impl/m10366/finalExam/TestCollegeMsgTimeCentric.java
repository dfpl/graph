...
public class TestCollegeMsgTimeCentric {
	...
	public static void main(String[] args) throws IOException {
		...
		BufferedReader br = new BufferedReader(new FileReader("D://dataset/CollegeMsg.txt"));
		BufferedWriter bw = new BufferedWriter(new FileWriter("D://dataset/reachability_timecentric_approach.txt"));
		...
		TemporalReachabilityTimeCentricApproach ta = new TemporalReachabilityTimeCentricApproach(graph,
				Long.valueOf(0));
		...
		for (TimeVertex vertex : graph.getVertices()) {
			...
			bw.write(vertex.getId() + "	" + String.valueOf(ta.getTemporalReachabilitySize(vertex.getId())) + "	"
